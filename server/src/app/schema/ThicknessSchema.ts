...
import IThicknessDocument from "@app/app/documents/IThicknessDocument";
...
export default Mongoose.model<IThicknessDocument>(DBNameConstant.THICKNESS, fileschema) as unknown as Mongoose.Model<Mongoose.Document>;
